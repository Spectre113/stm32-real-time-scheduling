...
| [`docs/`](docs/)                                                                                         | Ссылки на поддерживаемые презентацию и Colab notebook для анализа.                            |
...
`Debug/` и `Release/` - генерируемые результаты сборки; `node_modules/` - зависимости JavaScript. Локальные PDF-статьи и экспортированные версии презентации в `docs/` также игнорируются Git: актуальные презентация и notebook для обработки результатов доступны по ссылкам ниже. Эти файлы не должны добавляться в репозиторий.
